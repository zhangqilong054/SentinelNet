...
_KNOWN_BENIGN_JA3_RAW: list[str] = [
    # Chrome (各版本)
...
# 已知恶意 / 可疑 JA3 指纹（原始字符串，启动时转为 MD5 哈希集合）
_KNOWN_MALICIOUS_JA3_RAW: list[str] = [
    # Metasploit default
...
# D4: 启动时将 ja3_raw 预计算为 MD5 哈希集合，与 _classify_tls 中的 ja3_hash 比对口径一致
KNOWN_BENIGN_JA3: set[str] = {hashlib.md5(raw.encode()).hexdigest() for raw in _KNOWN_BENIGN_JA3_RAW}
KNOWN_MALICIOUS_JA3: set[str] = {hashlib.md5(raw.encode()).hexdigest() for raw in _KNOWN_MALICIOUS_JA3_RAW}
